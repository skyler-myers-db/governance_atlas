/**
 * Comprehensive Playwright QA for the deployed Governance Atlas app.
 *
 ...
 *
 * The script writes a JSON report to /tmp/govat-qa/report.json listing
...
const OUT_DIR =
  process.env.GOVAT_QA_OUT_DIR || path.join(REPO_ROOT, "docs", "screenshots", "qa");
...
if (!BASE_URL) {
  console.error("Usage: node frontend/scripts/atlas_comprehensive_qa.mjs <base-url>");
  process.exit(1);
}
